...
> 聚焦于垂直业务领域的闭源大语言模型汇总。原则上不收录纯 AI 技术本身（如通用大模型、AI 基础设施），但对于在特定专业工作流中形成明确商业闭环的领域产品（如面向软件开发的 Cursor、面向客服的 Sierra），即便涉及代码/对话，也作为"垂类工作流应用"予以收录。
...
| 21 | [软件开发](domains/software-development/) | AI 编程 Agent、代码补全、自主软件工程 |
| 22 | [客户服务](domains/customer-service/) | 对话式客服 Agent、工单自动化、结果优化 |
...
1. **原则上排除"AI技术本身"类**：如通用大模型、AI 基础设施、通用对话等。但对形成特定专业工作流商业闭环的垂类产品（软件开发 Cursor、客服 Sierra）作为"垂类工作流应用"收录
