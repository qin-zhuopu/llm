# Source: https://arxiv.org/abs/2306.16092
...
<head><script>document.documentElement.classList.add('js');</script>  <title>[2306.16092] Chatlaw: A Multi-Agent Legal Assistant based on a Role-Aligned Mixture-of-Experts Architecture</title>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="Chatlaw: A Multi-Agent Legal Assistant based on a Role-Aligned Mixture-of-Experts Architecture" /><meta name="citation_author" content="Cui, Jiaxi" /><meta name="citation_author" content="Ning, Munan" /><meta name="citation_author" content="Li, Zongjian" /><meta name="citation_author" content="Chen, Bohua" /><meta name="citation_author" content="Yan, Yang" /><meta name="citation_author" content="Li, Hao" /><meta name="citation_author" content="Ling, Bin" /><meta name="citation_author" content="Tian, Yonghong" /><meta name="citation_author" content="Yuan, Li" /><meta name="citation_doi" content="10.1016/j.fmre.2026.03.026" /><meta name="citation_date" content="2023/06/28" /><meta name="citation_online_date" content="2026/06/08" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2306.16092" /><meta name="citation_arxiv_id" content="2306.16092" /><meta name="citation_abstract" content="Artificial Intelligence (AI) holds great potential in legal services, yet Large Language Models (LLMs) face two major challenges: limited knowledge of the Chinese legal system and vulnerability to hallucinations. To address these issues, we present Chatlaw, a multi-agent legal assistant. Chatlaw&#39;s framework is designed to emulate the Standard Operating Procedures (SOP) of real law firms, where different roles (e.g., assistant, researcher, senior lawyer) collaborate on a case. To computationally mirror this collaborative structure, we developed a novel Role-Aligned Mixture-of-Experts (RA-MoE) architecture. In this system, the internal &#34;experts&#34; are specifically trained to align with the distinct tasks of each agent role (e.g., inquiry, analysis, drafting). These specialized agents (Legal Assistant, Researcher, etc.) then form the collaborative framework. When they interact with users, retrieve legal knowledge, analyze case details, or generate reliable consultations, the RA-MoE architecture intelligently routes their computations to the corresponding dedicated expert, ensuring each step is handled by the most qualified parameters. In evaluations, Chatlaw surpasses general-purpose AI models, including GPT-4, achieving a 7.73% improvement in accuracy on the LawBench benchmark and an 11-point higher score on the Unified Qualification Exam for Legal Professionals. Real-case studies and expert assessments further confirm its robustness. Chatlaw enhances the accessibility and reliability of legal services, advancing the provision of legal support to the public." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2306.16092"
        dc:identifier="/abs/2306.16092"
        dc:title="Chatlaw: A Multi-Agent Legal Assistant based on a Role-Aligned Mixture-of-Experts Architecture"
        trackback:ping="/trackback/2306.16092" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2306.16092</strong> (cs)
    </div>
<link rel="stylesheet" type="text/css" href="/static/base/1.0.1/css/abs.css">
<div id="content-inner">
  <div id="abs">
    <div class="dateline">
  [Submitted on 28 Jun 2023 (<a href="https://arxiv.org/abs/2306.16092v1">v1</a>), last revised 8 Jun 2026 (this version, v3)]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>Chatlaw: A Multi-Agent Legal Assistant based on a Role-Aligned Mixture-of-Experts Architecture</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Cui,+J" rel="nofollow">Jiaxi Cui</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Ning,+M" rel="nofollow">Munan Ning</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Li,+Z" rel="nofollow">Zongjian Li</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Chen,+B" rel="nofollow">Bohua Chen</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Yan,+Y" rel="nofollow">Yang Yan</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Li,+H" rel="nofollow">Hao Li</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Ling,+B" rel="nofollow">Bin Ling</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Tian,+Y" rel="nofollow">Yonghong Tian</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Yuan,+L" rel="nofollow">Li Yuan</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled Chatlaw: A Multi-Agent Legal Assistant based on a Role-Aligned Mixture-of-Experts Architecture, by Jiaxi Cui and 8 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2306.16092">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2306.16092v3">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>Artificial Intelligence (AI) holds great potential in legal services, yet Large Language Models (LLMs) face two major challenges: limited knowledge of the Chinese legal system and vulnerability to hallucinations. To address these issues, we present Chatlaw, a multi-agent legal assistant. Chatlaw&#39;s framework is designed to emulate the Standard Operating Procedures (SOP) of real law firms, where different roles (e.g., assistant, researcher, senior lawyer) collaborate on a case. To computationally mirror this collaborative structure, we developed a novel Role-Aligned Mixture-of-Experts (RA-MoE) architecture. In this system, the internal &#34;experts&#34; are specifically trained to align with the distinct tasks of each agent role (e.g., inquiry, analysis, drafting). These specialized agents (Legal Assistant, Researcher, etc.) then form the collaborative framework. When they interact with users, retrieve legal knowledge, analyze case details, or generate reliable consultations, the RA-MoE architecture intelligently routes their computations to the corresponding dedicated expert, ensuring each step is handled by the most qualified parameters. In evaluations, Chatlaw surpasses general-purpose AI models, including GPT-4, achieving a 7.73% improvement in accuracy on the LawBench benchmark and an 11-point higher score on the Unified Qualification Exam for Legal Professionals. Real-case studies and expert assessments further confirm its robustness. Chatlaw enhances the accessibility and reliability of legal services, advancing the provision of legal support to the public.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata">        <tr>
          ...
          <td class="tablecell comments mathjax">Accepted manuscript. Updated to match the journal version and added DOI</td>
        </tr>
<tr>
          ...
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2306.16092">arXiv:2306.16092</a> [cs.CL]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2306.16092v3">arXiv:2306.16092v3</a> [cs.CL]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2306.16092"  id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2306.16092</a><div class="button-and-tooltip">
          ...
          <td class="tablecell doi"><a href="https://doi.org/10.1016/j.fmre.2026.03.026" data-doi="10.1016/j.fmre.2026.03.026" class="link-https link-external" rel="external noopener nofollow">https://doi.org/10.1016/j.fmre.2026.03.026</a>
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Jiaxi Cui [<a href="/show-email/769de525/2306.16092" rel="nofollow">view email</a>]      <br/>            <strong><a href="/abs/2306.16092v1" rel="nofollow">[v1]</a></strong>
        Wed, 28 Jun 2023 10:48:34 UTC (1,040 KB)<br/>
            <strong><a href="/abs/2306.16092v2" rel="nofollow">[v2]</a></strong>
        Thu, 30 May 2024 13:46:00 UTC (2,294 KB)<br/>
    <strong>[v3]</strong>
        Mon, 8 Jun 2026 08:40:57 UTC (1,197 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled Chatlaw: A Multi-Agent Legal Assistant based on a Role-Aligned Mixture-of-Experts Architecture, by Jiaxi Cui and 8 other authors</div><li><a href="/pdf/2306.16092" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2306.16092v3" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2306.16092" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2306.16092&amp;function=prev&amp;context=cs.CL"
         accesskey="p" title="previous in cs.CL (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2306.16092&amp;function=next&amp;context=cs.CL" accesskey="n"
    ...
    <span class="is-hidden-mobile"> | </span><a class="abs-button abs-button-grey abs-button-small context-id" href="/list/cs.CL/2023-06" rel="nofollow">2023-06</a>
  </div><div class="abs-switch-cat">
    Change to browse by:
    <div class="switch context-change">
        <a href="/abs/2306.16092?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2306.16092">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2306.16092" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2306.16092" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2306.16092&amp;description=Chatlaw: A Multi-Agent Legal Assistant based on a Role-Aligned Mixture-of-Experts Architecture"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2306.16092&amp;title=Chatlaw: A Multi-Agent Legal Assistant based on a Role-Aligned Mixture-of-Experts Architecture"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2306.16092" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
