# Source: https://www.linkedin.com/learning/?trk=homepage-basic_directory_learningHomeUrl
...
<!---->
        ...
        <link rel="stylesheet" href="https://static.licdn.com/aero-v1/sc/h/e5zo8n2wrb217ln64telzsi12">
        
        <link rel="stylesheet" href="https://static.licdn.com/aero-v1/sc/h/f4vzkmj41xkbdxjqzhujumevb">
...
<!---->        
    ...
    <section class="dismissable-input text-input !pr-3 bg-color-transparent flex items-center h-[40px] min-w-0 relative babybear:w-full babybear:mb-1 typeahead-input location-typeahead-input">
      <input aria-autocomplete="list" aria-controls="job-search-bar-location-typeahead-list" aria-haspopup="listbox" aria-label="Location" autocomplete="off" class="dismissable-input__input font-sans text-md text-color-text bg-color-transparent flex items-center flex-1 focus:outline-none placeholder:text-color-text-secondary" data-tracking-control-name="homepage-learning_dismissable-input" id="job-search-bar-location" maxlength="500" name="location" placeholder="Location" role="combobox" value="Ashburn, VA" type="search">
...
<!---->    
        ...
        <input name="geoId" value="103056182" type="hidden">
    ...
    <section class="dismissable-input text-input !pr-3 bg-color-transparent flex items-center h-[40px] min-w-0 relative babybear:w-full babybear:mb-1 search-input">
      <input aria-label="Search skills, subjects, or software" autocomplete="on" class="dismissable-input__input font-sans text-md text-color-text bg-color-transparent flex items-center flex-1 focus:outline-none placeholder:text-color-text-secondary" data-tracking-control-name="homepage-learning_learning-search-bar_keywords_dismissable-input" maxlength="500" name="keywords" placeholder="Search skills, subjects, or software" type="search">
        ...
        <input class="nav__search-uoo" name="upsellOrderOrigin" value="homepage-basic_directory_learningHomeUrl" type="hidden">
...
<!---->
      ...
      <a class="nav__button-secondary btn-secondary-emphasis btn-md" href="https://www.linkedin.com/learning-login/?redirect=%2Flearning%2F%3FupsellOrderOrigin%3Dhomepage-basic_directory_learningHomeUrl&amp;upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;fromSignIn=true&amp;trk=homepage-learning_nav-header-signin" data-tracking-control-name="homepage-learning_nav-header-signin" data-tracking-will-navigate data-tracking-client-ingraph>
          Sign in
      </a>
...
<!---->    </nav>
    ...
    <div class="section flex-col pt-[60px] babybear:pt-[56px]">
      <h2 class="w-full pb-2 ml-2 text-display-md font-bold babybear:text-display-sm babybear:text-[20px]">
        Explore courses
      </h2>
...
<!---->
    ...
    <section class="slide-list relative  trending-courses" data-test-live-trending-courses data-test-id="trending-courses">
        <header class="slide-list__header mb-1.5">
                <h2 class="slide-list__heading font-bold mb-0.5 text-color-text text-lg"><a href="https://www.linkedin.com/learning/courses?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl" class="slide-list__heading-link" data-tracking-control-name="homepage-learning_trending-courses-topic-headline" data-tracking-will-navigate="true">Trending Courses</a></h2>
<!---->        </header>
      ...
      <a href="https://www.linkedin.com/learning/what-is-generative-ai?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, What Is Generative AI?, 1h 3m, 2,916,452 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
      ...
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="What Is Generative AI?" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQE84AgCpYxX-Q/learning-public-crop_144_256/learning-public-crop_144_256/0/1678908578362?e=1788390000&amp;v=beta&amp;t=xFaUXnCD-zqsX3tIHB8By5BWaT-L6fSR4KzQ9bgRjGI">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">2,916,452 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/learning-data-analytics-1-foundations?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Learning Data Analytics: 1 Foundations, 3h 29m, 929,596 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Learning Data Analytics: 1 Foundations" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQFGmlfFOyWc7g/learning-public-crop_144_256/learning-public-crop_144_256/0/1618937081114?e=1788390000&amp;v=beta&amp;t=4JqjdXLcOCk-7zlo2FFx584e6AvsLd5iNCuwaKZOPhs">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">929,596 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/electronics-foundations-basic-circuits?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Electronics Foundations: Basic Circuits, 4h 2m, 835,422 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Electronics Foundations: Basic Circuits" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQHbCh-IbN-ngA/learning-public-crop_144_256/learning-public-crop_144_256/0/1567116230457?e=1788390000&amp;v=beta&amp;t=dO07FzI0TtYYuqbgI72dva3Z0Ysm8dKTiEjRxGCHkk8">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">835,422 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/expert-tips-for-answering-common-interview-questions?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Expert Tips for Answering Common Interview Questions, 1h 14m, 2,616,373 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Expert Tips for Answering Common Interview Questions" data-delayed-url="https://media.licdn.com/dms/image/v2/C4D0DAQGJrfQlA5KMUQ/learning-public-crop_144_256/learning-public-crop_144_256/0/1669258879103?e=1788390000&amp;v=beta&amp;t=rnJAnVCMAI7EqY4m32gPgzdrN4-sAuq5lQ47gA9Xb3U">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">2,616,373 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/ethics-in-the-age-of-generative-ai?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Ethics in the Age of Generative AI, 45m, 799,059 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Ethics in the Age of Generative AI" data-delayed-url="https://media.licdn.com/dms/image/v2/D560DAQEnE2mUK2ogWg/learning-public-crop_144_256/learning-public-crop_144_256/0/1685035572840?e=1788390000&amp;v=beta&amp;t=TUUPy2JVt2xS1TQlxYfcELboLp7uiDXYc0qGnD6XEto">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">799,059 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/electronics-foundations-fundamentals?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Electronics Foundations: Fundamentals, 1h 17m, 712,706 viewers">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">712,706 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/critical-thinking-for-better-judgment-and-decision-making?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Critical Thinking for Better Judgment and Decision-Making, 56m, 1,608,817 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Critical Thinking for Better Judgment and Decision-Making" data-delayed-url="https://media.licdn.com/dms/image/v2/C560DAQG0m8N38Oox2Q/learning-public-crop_144_256/learning-public-crop_144_256/0/1658293981737?e=1788390000&amp;v=beta&amp;t=nEwORkLb360vg8U-FoHrvxE8DYlQCfuaMiOw2d-d0ak">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">1,608,817 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/prompt-engineering-how-to-talk-to-the-ais-2023?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Prompt Engineering: How to Talk to the AIs (2023), 29m, 777,288 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Prompt Engineering: How to Talk to the AIs (2023)" data-delayed-url="https://media.licdn.com/dms/image/v2/D560DAQFSXS6mzs87pA/learning-public-crop_144_256/learning-public-crop_144_256/0/1681413686159?e=1788390000&amp;v=beta&amp;t=GTbAkmWzFAl2_MxUtbtAypFWtWS2Y08US3t-TBMOpUw">
        <div class="related-entity-media__duration duration">
...
<!---->    </div>
      ...
      <div class="related-content-card__info flex flex-col mt-1">
        <h3 class="related-content-card__title font-sans text-[18px] font-bold text-color-text line-clamp-2">
          Prompt Engineering: How to Talk to the AIs (2023)
        </h3>

<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              
              <p class="learning-related-content-card__viewers">777,288 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/construction-management-managing-risk?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Construction Management: Managing Risk, 1h 16m, 644,658 viewers">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">644,658 viewers</p>
...
<!---->
  ...
  <section class="section py-section flex-wrap babybear:flex-col papabear:flex-row papabear:items-start lazy-load after-lazy-bg-icon-topic after:content-[''] after:full-color-bkg after:bg-blue-90 after:!bg-cover flex-col" data-test-id="popular-topics">
        ...
        <h2 class="header !text-color-text-on-dark">
          Find the right course for you
            ...
            <p class="body mt-1.5 !text-color-text-on-dark">
              Choose from over <a href="https://www.linkedin.com/learning/courses?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl" class="link-on-dark-bg" data-tracking-control-name="homepage-learning_all-courses-link" data-tracking-will-navigate="true">26,200 courses</a> and <a href="https://www.linkedin.com/learning/paths?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl" class="link-on-dark-bg" data-tracking-control-name="homepage-learning_all-paths-link" data-tracking-will-navigate="true">Learning Paths</a>, dozens added each week.
            </p>
      ...
      <ul class="show-more-less__list show-more-less__list--no-hidden-elems etta-show-more-less !btn-dark-bkg" data-impression-id="homepage-learning_pill-list-module_etta-show-more-less_show-more-less">
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/data-analysis?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/microcontrollers-23312806?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/job-searching?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/electrical-engineering?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/electronics?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/hiring-and-interviewing?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/responsible-ai-and-ethics?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/construction-management?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/decision-making?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/2016-108?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/ai-assisted-design-and-media?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
          
                AI-Assisted Design and Media
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/prompting?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/creativity-3?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
...
<!---->
    ...
    <section class="slide-list relative  trending-courses" data-test-live-trending-courses data-test-id="trending-courses">
        <header class="slide-list__header mb-1.5">
                <h2 class="slide-list__heading font-bold mb-0.5 text-color-text text-lg"><a href="https://www.linkedin.com/learning/topics/business?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl" class="slide-list__heading-link" data-tracking-control-name="homepage-learning_trending-courses-topic-headline" data-tracking-will-navigate="true">Trending Business Courses</a></h2>
<!---->        </header>
...
<!---->
      ...
      <a href="https://www.linkedin.com/learning/critical-thinking?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Critical Thinking, 1h 6m, 1,449,660 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Critical Thinking" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQGRLaOVaDrWFw/learning-public-crop_144_256/learning-public-crop_144_256/0/1593630205638?e=1788390000&amp;v=beta&amp;t=YO9zHtPdoshdo2NghYeYvB_dxC3Z7qyjT9UdMAOo9I8">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">1,449,660 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/project-management-foundations-15528659?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Project Management Foundations, 4h 1m, 1,379,876 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Project Management Foundations" data-delayed-url="https://media.licdn.com/dms/image/v2/C560DAQE_1UWtPeV57w/learning-public-crop_144_256/learning-public-crop_144_256/0/1665506470259?e=1788390000&amp;v=beta&amp;t=I3Gg9ELumWLpNX8AQs5NVlG9gcIrkP5AUbmVW6vddCY">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">1,379,876 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/agile-foundations?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Agile Foundations, 2h, 1,311,601 viewers">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">1,311,601 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/how-to-use-linkedin-learning?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, How to Use LinkedIn Learning, 1h 13m, 1,281,035 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="How to Use LinkedIn Learning" data-delayed-url="https://media.licdn.com/dms/image/v2/D560DAQHU4Bru050pJQ/learning-public-crop_144_256/B56Z7cZUIeH4AE-/0/1781814084373?e=1788390000&amp;v=beta&amp;t=rKV8JU3ZOsyQs-cng-t4ZTuA5ivV4kH73vEpbpAL2Xc">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">1,281,035 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/time-management-working-from-home-2018?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Time Management: Working from Home (2018), 1h 17m, 1,234,241 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Time Management: Working from Home (2018)" data-delayed-url="https://media.licdn.com/dms/image/v2/C4D0DAQEz0gn8a-yEXw/learning-public-crop_144_256/learning-public-crop_144_256/0/1651077495981?e=1788390000&amp;v=beta&amp;t=zYApTwI4UGTcPTUKGIzrA7ZHQtDVV-4Aq3LhMLFRd30">
        <div class="related-entity-media__duration duration">
...
<!---->    </div>
      ...
      <div class="related-content-card__info flex flex-col mt-1">
        <h3 class="related-content-card__title font-sans text-[18px] font-bold text-color-text line-clamp-2">
          Time Management: Working from Home (2018)
        </h3>

<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              
              <p class="learning-related-content-card__viewers">1,234,241 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/diversity-inclusion-and-belonging-2019?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        ...
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Diversity, Inclusion, and Belonging, 35m, 1,229,343 viewers">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">1,229,343 viewers</p>
...
<!---->
  ...
  <section class="section py-section flex-wrap babybear:flex-col papabear:flex-row papabear:items-start lazy-load after-lazy-bg-icon-topic after:content-[''] after:full-color-bkg after:bg-blue-90 after:!bg-cover flex-col" data-test-id="popular-topics">
      ...
      <ul class="show-more-less__list show-more-less__list--no-hidden-elems etta-show-more-less !btn-dark-bkg" data-impression-id="homepage-learning_pill-list-module_etta-show-more-less_show-more-less">
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/project-management-skills?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/agile-project-management?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/time-management?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/remote-work?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/inclusive-leadership?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/dei-culture?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/public-speaking?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/presentations?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
...
<!---->
    ...
    <section class="slide-list relative  trending-courses" data-test-live-trending-courses data-test-id="trending-courses">
        <header class="slide-list__header mb-1.5">
                <h2 class="slide-list__heading font-bold mb-0.5 text-color-text text-lg"><a href="https://www.linkedin.com/learning/topics/technology?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl" class="slide-list__heading-link" data-tracking-control-name="homepage-learning_trending-courses-topic-headline" data-tracking-will-navigate="true">Trending Technology Courses</a></h2>
<!---->        </header>
...
<!---->
      ...
      <a href="https://www.linkedin.com/learning/excel-creating-a-basic-dashboard-2022?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Excel: Creating a Basic Dashboard, 1h 6m, 723,745 viewers">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">723,745 viewers</p>
...
<!---->
      ...
      <a href="https://www.linkedin.com/learning/programming-foundations-fundamentals-3?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Programming Foundations: Fundamentals, 3h 11m, 679,065 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Programming Foundations: Fundamentals" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQHzuVGwXVOhcA/learning-public-crop_144_256/learning-public-crop_144_256/0/1664503979068?e=1788390000&amp;v=beta&amp;t=MHkiRNtt-hrVW5z5rKOrZzyEGmxZU49fvvUho3ngpV8">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">679,065 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/python-essential-training-18764650?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Python Essential Training, 4h 23m, 646,624 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Python Essential Training" data-delayed-url="https://media.licdn.com/dms/image/v2/D560DAQEruxcXLwzu_A/learning-public-crop_144_256/B56Z1oT93iKkAQ-/0/1775571558115?e=1788390000&amp;v=beta&amp;t=a8iCwVBacS13UhkppuL09x2Q6TdglTyUSRF_XGZI5Y8">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">646,624 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/excel-data-visualization-mastering-20-plus-charts-and-graphs?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Excel Data Visualization: Mastering 20+ Charts and Graphs, 2h 23m, 638,433 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Excel Data Visualization: Mastering 20+ Charts and Graphs" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQHtKscjddJ3Xg/learning-public-crop_144_256/learning-public-crop_144_256/0/1568066281564?e=1788390000&amp;v=beta&amp;t=wRUG3swZqfi91ak3B633bryc-dMfq1q3afAQgmmllIc">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">638,433 viewers</p>
...
<!---->
  ...
  <section class="section py-section flex-wrap babybear:flex-col papabear:flex-row papabear:items-start lazy-load after-lazy-bg-icon-topic after:content-[''] after:full-color-bkg after:bg-blue-90 after:!bg-cover flex-col" data-test-id="popular-topics">
      ...
      <ul class="show-more-less__list show-more-less__list--no-hidden-elems etta-show-more-less !btn-dark-bkg" data-impression-id="homepage-learning_pill-list-module_etta-show-more-less_show-more-less">
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/machine-learning-fundamentals?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/spreadsheets?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/programming-foundations?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/data-visualization?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/database-administration?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/database-development?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
...
<!---->
    ...
    <section class="slide-list relative  trending-courses" data-test-live-trending-courses data-test-id="trending-courses">
        <header class="slide-list__header mb-1.5">
                <h2 class="slide-list__heading font-bold mb-0.5 text-color-text text-lg"><a href="https://www.linkedin.com/learning/topics/creative?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl" class="slide-list__heading-link" data-tracking-control-name="homepage-learning_trending-courses-topic-headline" data-tracking-will-navigate="true">Trending Creative Courses</a></h2>
<!---->        </header>
...
<!---->
      ...
      <a href="https://www.linkedin.com/learning/discover-the-possibilities-of-generative-ai?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Discover the Possibilities of Generative AI, 11m, 568,725 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Discover the Possibilities of Generative AI" data-delayed-url="https://media.licdn.com/dms/image/v2/C560DAQEayGdFL5OhhQ/learning-public-crop_144_256/learning-public-crop_144_256/0/1675884235222?e=1788390000&amp;v=beta&amp;t=Ud9dSybFeFeB_ct2HJhGGUgIh6Znow0bi3Uxd0p8IYc">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">568,725 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/thinking-creatively?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Thinking Creatively, 41m, 459,938 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Thinking Creatively" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQGoMqoC1oFuYg/learning-public-crop_144_256/learning-public-crop_144_256/0/1568071018479?e=1788390000&amp;v=beta&amp;t=ZkGJL02KHJwFuBGJ6hpA-v-AV3GLm9Rd_MnfztjkI1s">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">459,938 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/practical-engineering?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Practical Engineering, 6h 2m, 433,366 viewers">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">433,366 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/psychological-safety-clear-blocks-to-innovation-collaboration-and-risk-taking?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Psychological Safety: Clear Blocks to Innovation, Collaboration, and Risk-Taking, 34m, 424,024 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Psychological Safety: Clear Blocks to Innovation, Collaboration, and Risk-Taking" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQE4BKHgZRQr6A/learning-public-crop_144_256/learning-public-crop_144_256/0/1583518424083?e=1788390000&amp;v=beta&amp;t=M9B9WuNaSACZb-blao-KO4Y6YgY9AxQJjHK44ZNHhXo">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">424,024 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/graphic-design-tips-tricks?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, Graphic Design Tips &amp;amp; Tricks, 10h 53m, 402,989 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="Graphic Design Tips &amp; Tricks" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQFYzzHHVu0gIA/learning-public-crop_144_256/learning-public-crop_144_256/0/1567794767123?e=1788390000&amp;v=beta&amp;t=z8bRUpydt1oOIpkPKfizaRQn4YDN68DHIVOjar0aTdk">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">402,989 viewers</p>
      ...
      <a href="https://www.linkedin.com/learning/ai-and-digital-marketing-trends?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_trending-courses_related-content-card" target="_self" data-tracking-control-name="homepage-learning_trending-courses_related-content-card" data-tracking-will-navigate class="base-card relative w-full hover:no-underline focus:no-underline
        base-card--link
        outline-offset-[4px] related-content-card w-[228px] block relative
        
        related-content-card--link absolute z-[1] top-0 bottom-0 left-0 right-0 hover:no-underline focus:no-underline" aria-label="Course, AI and Digital Marketing Trends, 1h 57m, 388,471 viewers">
...
<!---->
    ...
    <div class="related-entity-media relative block
        w-[228px] h-[134px] rounded-md">
      <img class="related-entity-media__img w-full h-full object-cover rounded-md" alt="AI and Digital Marketing Trends" data-delayed-url="https://media.licdn.com/dms/image/v2/C4E0DAQFft8r4rNy0kw/learning-public-crop_144_256/learning-public-crop_144_256/0/1567631258088?e=1788390000&amp;v=beta&amp;t=wASWLc21mei_TEVAjArKXN_BpOTi-5VRrumCMdIxDcE">
        <div class="related-entity-media__duration duration">
...
<!---->
            <div class="font-sans font-regular text-sm text-color-text-low-emphasis mt-0.5 line-clamp-3 related-content-card__metadata">
              ...
              <p class="learning-related-content-card__viewers">388,471 viewers</p>
...
<!---->
  ...
  <section class="section py-section flex-wrap babybear:flex-col papabear:flex-row papabear:items-start lazy-load after-lazy-bg-icon-topic after:content-[''] after:full-color-bkg after:bg-blue-90 after:!bg-cover flex-col" data-test-id="popular-topics">
      ...
      <ul class="show-more-less__list show-more-less__list--no-hidden-elems etta-show-more-less !btn-dark-bkg" data-impression-id="homepage-learning_pill-list-module_etta-show-more-less_show-more-less">
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/3-92?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/leadership-skills?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/emotional-intelligence?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/well-being-and-self-care?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/design-business?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/drawing?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/content-strategy?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
        ...
        <a class="btn-md babybear:btn-sm mb-1.5 mr-1 flex items-center w-fit float-left btn-dark-bkg" data-tracking-control-name="homepage-learning" data-tracking-will-navigate href="https://www.linkedin.com/learning/topics/advertising-and-promotion?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning" data-test-live-popular-topics-link>
    ...
    <section class="tw-linkster bg-cool-gray-20 w-full" data-impression-id="homepage-learning_linkster" data-js-module-id="linkster" data-test-id="linkster">
      ...
      <div class="flex-1 w-1/2 pt-2 pr-4 pb-4 pl-0 babybear:pb-2 babybear:w-full babybear:border-b-1 babybear:border-solid babybear:border-color-border-low-emphasis babybear:last:border-b-0">
          <h3 class="text-md font-bold text-color-text leading-open">
            <a href="https://www.linkedin.com/learning/topics/business?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl" class="link-styled" data-tracking-control-name="homepage-learning_linkster-column-title" data-tracking-will-navigate="true" data-impression-id="homepage-learning_linkster-column-title">Explore Business Topics</a>
          </h3>
        <ul class="my-1">
            <li class="tw-link-column-item">
              
              
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/business-analysis-and-strategy?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/business-software-and-tools?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/career-development-5?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Career Development
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/customer-service-3?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Customer Service
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/diversity-equity-and-inclusion-dei?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/finance-and-accounting?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/human-resources-3?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Human Resources
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/leadership-and-management?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/marketing-2?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Marketing
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/professional-development?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/project-management?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Project Management
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/sales-3?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Sales
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/small-business-and-entrepreneurship?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/training-and-education?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Training and Education
              </a>
            </li>
        </ul>

          <a class="link tw-linkster-general-link" aria-label="See all Business courses" href="https://www.linkedin.com/learning/topics/business?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_general-link" data-tracking-control-name="homepage-learning_linkster_general-link" data-tracking-will-navigate>
              See all
          </a>
      </div>
      ...
      <div class="flex-1 w-1/2 pt-2 pr-4 pb-4 pl-0 babybear:pb-2 babybear:w-full babybear:border-b-1 babybear:border-solid babybear:border-color-border-low-emphasis babybear:last:border-b-0">
          <h3 class="text-md font-bold text-color-text leading-open">
            <a href="https://www.linkedin.com/learning/topics/creative?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl" class="link-styled" data-tracking-control-name="homepage-learning_linkster-column-title" data-tracking-will-navigate="true" data-impression-id="homepage-learning_linkster-column-title">Explore Creative Topics</a>
          </h3>
        <ul class="my-1">
            <li class="tw-link-column-item">
              
              
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/aec?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                AEC
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/animation-and-illustration?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/audio-and-music?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Audio and Music
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/graphic-design?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Graphic Design
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/motion-graphics-and-vfx?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/photography-2?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Photography
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/product-and-manufacturing?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/user-experience?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                User Experience
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/2015-54?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Video
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/visualization-and-real-time?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/web-design?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Web Design
              </a>
            </li>
        </ul>
      ...
      <div class="flex-1 w-1/2 pt-2 pr-4 pb-4 pl-0 babybear:pb-2 babybear:w-full babybear:border-b-1 babybear:border-solid babybear:border-color-border-low-emphasis babybear:last:border-b-0">
        ...
        <ul class="my-1">
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/artificial-intelligence?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/cloud-computing-5?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Cloud Computing
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/security-3?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Cybersecurity
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/data-science?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Data Science
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/database-management?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Database Management
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/devops?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                DevOps
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/hardware?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Hardware
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/it-help-desk-5?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                IT Help Desk
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/mobile-development?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Mobile Development
              </a>
            </li>
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/network-and-system-administration?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/software-development?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
            ...
            <li class="tw-link-column-item">
              ...
              <a class="link tw-linkster-link" href="https://www.linkedin.com/learning/topics/web-development?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_linkster_link" data-js-module-id="link-column-link" data-tracking-control-name="homepage-learning_linkster_link" data-tracking-will-navigate>
                Web Development
              </a>
            </li>
        </ul>
    ...
    <section class="directory section w-full flex justify-between pt-3 pb-3 after:full-color-bkg after:content-[''] after:bg-color-background-canvas babybear:flex-col babybear:max-w-full babybear:py-3 babybear:px-mobile-container-padding" data-impression-id="homepage-learning_directory" data-test-id="directory-section">
      ...
      <div class="w-full flex justify-end pl-2 babybear:flex-col babybear:flex-wrap babybear:mt-3 babybear:pl-0">
          <div class="w-full max-w-[192px] mr-3">
            ...
            <ul>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/signup?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=guest_homepage-learning_directory" data-tracking-control-name="guest_homepage-learning_directory" data-tracking-will-navigate>
                      Sign Up
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/help/linkedin?lang=en&amp;upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_helpCenterUrl" data-tracking-control-name="homepage-learning_directory_helpCenterUrl" data-tracking-will-navigate>
                      Help Center
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://about.linkedin.com/?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_aboutUrl" data-tracking-control-name="homepage-learning_directory_aboutUrl" data-tracking-will-navigate>
                      About
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://press.linkedin.com/?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_pressMicrositeUrl" data-tracking-control-name="homepage-learning_directory_pressMicrositeUrl" data-tracking-will-navigate>
                      Press
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://blog.linkedin.com/?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_blogMicrositeUrl" data-tracking-control-name="homepage-learning_directory_blogMicrositeUrl" data-tracking-will-navigate>
                      Blog
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/company/linkedin/jobs?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_careersUrl" data-tracking-control-name="homepage-learning_directory_careersUrl" data-tracking-will-navigate>
                      Careers
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://developer.linkedin.com/?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_developerMicrositeUrl" data-tracking-control-name="homepage-learning_directory_developerMicrositeUrl" data-tracking-will-navigate>
                      Developers
                    </a>
                  </li>
            </ul>
          ...
          <div class="w-full max-w-[192px] mr-3">
            ...
            <ul>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/learning/?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_learningHomeUrl" data-tracking-control-name="homepage-learning_directory_learningHomeUrl" data-tracking-will-navigate>
                      Learning
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/jobs?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_jobsHomeUrl" data-tracking-control-name="homepage-learning_directory_jobsHomeUrl" data-tracking-will-navigate>
                      Jobs
                    </a>
                  </li>
<!---->                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://members.linkedin.com/apps?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_mobileMicrositeUrl" data-tracking-control-name="homepage-learning_directory_mobileMicrositeUrl" data-tracking-will-navigate>
                      Mobile
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/services?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_servicesHomeUrl" data-tracking-control-name="homepage-learning_directory_servicesHomeUrl" data-tracking-will-navigate>
                      Services
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/products?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_productsHomeUrl" data-tracking-control-name="homepage-learning_directory_productsHomeUrl" data-tracking-will-navigate>
                      Products
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/hubs/top-companies/?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_topCompaniesHubHomeUrl" data-tracking-control-name="homepage-learning_directory_topCompaniesHubHomeUrl" data-tracking-will-navigate>
                      Top Companies
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/hubs/top-startups/?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_topStartupsHubHomeUrl" data-tracking-control-name="homepage-learning_directory_topStartupsHubHomeUrl" data-tracking-will-navigate>
                      Top Startups
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/hubs/top-colleges/?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_topCollegesHubHomeUrl" data-tracking-control-name="homepage-learning_directory_topCollegesHubHomeUrl" data-tracking-will-navigate>
                      Top Colleges
                    </a>
                  </li>
            </ul>
          ...
          <div class="w-full max-w-[192px] mr-3">
            ...
            <ul>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://business.linkedin.com/talent-solutions?src=li-footer&amp;utm_source=linkedin&amp;utm_medium=footer&amp;upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_talentSolutionsMicrositeUrl" data-tracking-control-name="homepage-learning_directory_talentSolutionsMicrositeUrl" data-tracking-will-navigate>
                      Talent
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://business.linkedin.com/marketing-solutions?src=li-footer&amp;utm_source=linkedin&amp;utm_medium=footer&amp;upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_marketingSolutionsMicrositeUrl" data-tracking-control-name="homepage-learning_directory_marketingSolutionsMicrositeUrl" data-tracking-will-navigate>
                      Marketing
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://business.linkedin.com/sales-solutions?src=li-footer&amp;utm_source=linkedin&amp;utm_medium=footer&amp;upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_salesSolutionsMicrositeUrl" data-tracking-control-name="homepage-learning_directory_salesSolutionsMicrositeUrl" data-tracking-will-navigate>
                      Sales
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://learning.linkedin.com/?src=li-footer&amp;upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_learningMicrositeUrl" data-tracking-control-name="homepage-learning_directory_learningMicrositeUrl" data-tracking-will-navigate>
                      Learning
                    </a>
                  </li>
            </ul>
          ...
          <div class="w-full max-w-[192px] mr-3">
            ...
            <ul>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/people?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_peopleDirectoryUrl" data-tracking-control-name="homepage-learning_directory_peopleDirectoryUrl" data-tracking-will-navigate>
                      Members
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/jobs?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_jobSearchDirectoryUrl" data-tracking-control-name="homepage-learning_directory_jobSearchDirectoryUrl" data-tracking-will-navigate>
                      Jobs
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/companies?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_companyDirectoryUrl" data-tracking-control-name="homepage-learning_directory_companyDirectoryUrl" data-tracking-will-navigate>
                      Companies
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/featured?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_featuredDirectoryUrl" data-tracking-control-name="homepage-learning_directory_featuredDirectoryUrl" data-tracking-will-navigate>
                      Featured
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/learning?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_learningDirectoryUrl" data-tracking-control-name="homepage-learning_directory_learningDirectoryUrl" data-tracking-will-navigate>
                      Learning
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/posts?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_postsDirectoryUrl" data-tracking-control-name="homepage-learning_directory_postsDirectoryUrl" data-tracking-will-navigate>
                      Posts
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/articles?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_articlesDirectoryUrl" data-tracking-control-name="homepage-learning_directory_articlesDirectoryUrl" data-tracking-will-navigate>
                      Articles
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/schools?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_schoolsDirectoryUrl" data-tracking-control-name="homepage-learning_directory_schoolsDirectoryUrl" data-tracking-will-navigate>
                      Schools
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/news?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_newsDirectoryUrl" data-tracking-control-name="homepage-learning_directory_newsDirectoryUrl" data-tracking-will-navigate>
                      News
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/newsletters?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_newslettersDirectoryUrl" data-tracking-control-name="homepage-learning_directory_newslettersDirectoryUrl" data-tracking-will-navigate>
                      News Letters
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/services?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_servicesDirectoryUrl" data-tracking-control-name="homepage-learning_directory_servicesDirectoryUrl" data-tracking-will-navigate>
                      Services
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/products?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_productsDirectoryUrl" data-tracking-control-name="homepage-learning_directory_productsDirectoryUrl" data-tracking-will-navigate>
                      Products
                    </a>
                  </li>
                  <li class="babybear:my-1 babybear:max-w-full">
                    <a class="font-sans text-sm text-black-a60 font-bold leading-regular visited:text-black-a60 hover:visited:text-blue-70" href="https://www.linkedin.com/directory/people-search?upsellOrderOrigin=homepage-basic_directory_learningHomeUrl&amp;trk=homepage-learning_directory_peopleSearchDirectoryUrl" data-tracking-control-name="homepage-learning_directory_peopleSearchDirectoryUrl" data-tracking-will-navigate>
                      People Search
                    </a>
                  </li>
            </ul>
...
<!---->          
        ...
        <script src="https://static.licdn.com/aero-v1/sc/h/7hunl6bj2k62c7515ossc7vsh" async defer></script>
